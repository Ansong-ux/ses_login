...
async function fixDatabase() {
  ...
  try {
    ...
    console.log('Creating academic_terms table...');
    await client.query(`
    ...
    console.log('Inserting sample student assignments...');
    await client.query(`
    ...
    await client.query(`CREATE INDEX IF NOT EXISTS idx_student_assignments_student_id ON student_assignments(student_id)`);
    await client.query(`CREATE INDEX IF NOT EXISTS idx_student_assignments_assignment_id ON student_assignments(assignment_id)`);
    await client.query(`CREATE INDEX IF NOT EXISTS idx_academic_terms_active ON academic_terms(is_active)`);

    console.log('✅ Database fixes completed successfully!');
    console.log('Tables created: academic_terms, assignments, student_assignments');
    console.log('Columns added: first_name, last_name to users table');
